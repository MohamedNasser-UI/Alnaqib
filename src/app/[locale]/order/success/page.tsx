  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center">
      <div className="rounded-2xl border border-stone-200 bg-stone-50 p-10 dark:border-amber-900/40 dark:bg-stone-900/30">
        <h1 className="text-2xl font-bold text-amber-700 dark:text-amber-400">{t('successTitle')}</h1>
        <p className="mt-4 text-stone-600 dark:text-stone-300">{t('successMessage')}</p>
        <Link
          href={base || '/'}
